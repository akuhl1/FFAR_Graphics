...
file <- "C:\\Users\\kuhlalex\\OneDrive - Michigan State University\\Water Cycling Indicators\\Data\\Soil Moisture Sensor Data\\Zentra_API\\Tall\\all_dat_3.csv" # set the working directory
...
get_wc_d_plot <- function(dat, t1, t2){
     ...
     xlab("Date") + ylab("Water Content (cm^3/cm^3)") +
     xlim(c(t1, t2)) + facet_grid(Port ~ Treatment)
     return(p3)
}
