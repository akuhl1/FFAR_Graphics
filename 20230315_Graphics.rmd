...
t2 <- as_datetime("2022-11-04 01:00:00")

p2 <- ggplot() + geom_line(data = zentra_WC[zentra_WC$Site == "MI" & zentra_WC$Treatment == "AD",], 
...
```{r plot water content all minus noisy set, echo = FALSE, warning = FALSE}
t1 <- as_datetime("2022-07-01 01:00:00")
t2 <- as_datetime("2022-11-04 01:00:00")
